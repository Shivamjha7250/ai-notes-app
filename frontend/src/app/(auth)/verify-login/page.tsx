    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#050A18] relative overflow-hidden font-sans text-white p-4">
      ...
      <div className="z-10 w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-center uppercase tracking-[2px]">Secure Login</h1>
        </div>
        ...
        >
          ...
          <div className="mt-8 flex flex-col items-center gap-5">
            <p className="text-sm text-gray-400">
              ...
              <button type="button" className="text-blue-400 font-semibold hover:underline">Resend Code</button>
            </p>
